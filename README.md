...
[https://yousefjavaherian.github.io/nimbaha/](https://yjavaherian.github.io/nimbaha/)

### ۲. استفاده از فایل IP ها (برای کاربران حرفه‌ای)

ابتدا آخرین لیست IP ها را از [صفحه Releases](https://github.com/yjavaherian/nimbaha/releases) دانلود کرده و سپس از دستور زیر در ترمینال لینوکس یا مک استفاده کنید:
